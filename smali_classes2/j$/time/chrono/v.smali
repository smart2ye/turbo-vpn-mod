...
.method public final H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-virtual {v4}, Lj$/time/LocalDate;->L()I
...
.method public final f(Lj$/time/chrono/m;I)I
    ...
    invoke-static {p2}, Lj$/time/chrono/y;->f(Lj$/time/LocalDate;)Lj$/time/chrono/y;
...
.method public final z(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/b;
    .locals 13
    ...
    .line 447
    invoke-virtual {p0, v0}, Lj$/time/chrono/v;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 382
    invoke-static {v1}, Lj$/time/chrono/y;->k(I)Lj$/time/chrono/y;
    ...
    .line 452
    invoke-virtual {p0, v3}, Lj$/time/chrono/v;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 762
    iget p2, v8, Lj$/time/LocalDate;->a:I
    ...
    invoke-static {v0, v1, v10, v11}, Lj$/com/android/tools/r8/a;->U(JJ)J
    ...
    invoke-static {v2, v3, v10, v11}, Lj$/com/android/tools/r8/a;->U(JJ)J
    ...
    invoke-virtual {p1, v0, v1, p2}, Lj$/time/chrono/x;->T(JLj$/time/temporal/b;)Lj$/time/chrono/x;

    move-result-object p1

    sget-object p2, Lj$/time/temporal/b;->DAYS:Lj$/time/temporal/b;

    invoke-virtual {p1, v2, v3, p2}, Lj$/time/chrono/x;->T(JLj$/time/temporal/b;)Lj$/time/chrono/x;
    ...
    .line 487
    :cond_3
    invoke-virtual {p0, v4}, Lj$/time/chrono/v;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 488
    invoke-virtual {p0, v7}, Lj$/time/chrono/v;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 498
    invoke-virtual {p1, p2}, Lj$/time/chrono/x;->V(Lj$/time/f;)Lj$/time/chrono/x;
    ...
    .line 225
    invoke-static {v1, v9}, Lj$/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 234
    invoke-virtual {p1, v8}, Lj$/time/LocalDate;->V(Lj$/time/LocalDate;)Z
    ...
    .line 306
    invoke-virtual {v8}, Lj$/time/LocalDate;->U()I

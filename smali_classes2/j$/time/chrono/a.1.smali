...
.method public static l(Ljava/util/Map;Lj$/time/temporal/a;J)V
    .locals 3
...
.method public static p(Lj$/time/chrono/a;Ljava/lang/String;)Lj$/time/chrono/l;
    .locals 2
    ...
    .line 160
    invoke-interface {p0}, Lj$/time/chrono/l;->t()Ljava/lang/String;
...
.method public static q(Lj$/time/chrono/b;JJJ)Lj$/time/chrono/b;
    .locals 4
    ...
    .line 639
    invoke-static {p5, p6, p2, p3}, Lj$/com/android/tools/r8/a;->U(JJ)J
    ...
    .line 642
    invoke-static {p1}, Lj$/time/d;->P(I)Lj$/time/d;
    ...
    .line 642
    invoke-interface {p0, p2}, Lj$/time/chrono/b;->i(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
# virtual methods
.method public G(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/b;
    .locals 19
    ...
    invoke-interface {v0, v1, v2}, Lj$/time/chrono/l;->j(J)Lj$/time/chrono/b;
    ...
    .line 444
    :cond_0
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->u(Ljava/util/Map;Lj$/time/format/E;)V

    .line 447
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->z(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/b;
    ...
    .line 456
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->v(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/b;
    ...
    .line 566
    invoke-interface {v0, v3}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-static {v10, v11, v6, v7}, Lj$/com/android/tools/r8/a;->U(JJ)J
    ...
    invoke-static {v1, v2, v6, v7}, Lj$/com/android/tools/r8/a;->U(JJ)J

    move-result-wide v1

    .line 571
    invoke-interface {v0, v3, v8, v8}, Lj$/time/chrono/l;->D(III)Lj$/time/chrono/b;
    ...
    .line 573
    :cond_3
    invoke-interface {v0, v4}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 574
    invoke-interface {v0, v5}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 575
    invoke-interface {v0, v9}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 576
    invoke-interface {v0, v3, v6, v8}, Lj$/time/chrono/l;->D(III)Lj$/time/chrono/b;
    ...
    invoke-interface {v1, v4}, Lj$/time/temporal/TemporalAccessor;->n(Lj$/time/temporal/q;)I
    ...
    invoke-static/range {v12 .. v18}, Lj$/time/chrono/a;->q(Lj$/time/chrono/b;JJJ)Lj$/time/chrono/b;
    ...
    invoke-static {v1}, Lj$/time/d;->P(I)Lj$/time/d;
    ...
    .line 594
    invoke-interface {v3, v5}, Lj$/time/chrono/b;->i(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    .line 559
    invoke-interface {v0, v3, v8}, Lj$/time/chrono/l;->x(II)Lj$/time/chrono/b;
    ...
    .line 562
    invoke-interface {v0, v3, v1}, Lj$/time/chrono/l;->x(II)Lj$/time/chrono/b;
    ...
    invoke-static {v2, v3, v6, v7}, Lj$/com/android/tools/r8/a;->U(JJ)J
    ...
    .line 606
    invoke-interface {v0, v9, v8}, Lj$/time/chrono/l;->x(II)Lj$/time/chrono/b;
    ...
    invoke-interface {v1, v3}, Lj$/time/temporal/TemporalAccessor;->n(Lj$/time/temporal/q;)I
    ...
    invoke-static/range {v10 .. v16}, Lj$/time/chrono/a;->q(Lj$/time/chrono/b;JJJ)Lj$/time/chrono/b;
    ...
    .line 626
    invoke-interface {v4, v5}, Lj$/time/chrono/b;->i(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
.method public abstract synthetic n()Lj$/time/chrono/b;
.end method
...
.method public r(Lj$/time/LocalDateTime;)Lj$/time/chrono/e;
    ...
    .line 477
    :try_start_0
    invoke-interface {p0, p1}, Lj$/time/chrono/l;->o(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/b;
...
.method public u(Ljava/util/Map;Lj$/time/format/E;)V
    .locals 5
    ...
    .line 490
    :cond_0
    invoke-virtual {p0}, Lj$/time/chrono/a;->n()Lj$/time/chrono/b;
    ...
    invoke-interface {p2, v0}, Lj$/time/temporal/TemporalAccessor;->n(Lj$/time/temporal/q;)I

    move-result v1

    int-to-long v1, v1

    invoke-static {p1, v0, v1, v2}, Lj$/time/chrono/a;->l(Ljava/util/Map;Lj$/time/temporal/a;J)V
...
.method public v(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/b;
    .locals 7

    .line 536
    sget-object v0, Lj$/time/temporal/a;->YEAR:Lj$/time/temporal/a;

    invoke-interface {p0, v0}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-static {v3, v4, v5, v6}, Lj$/com/android/tools/r8/a;->U(JJ)J
    ...
    invoke-static {p1, p2, v5, v6}, Lj$/com/android/tools/r8/a;->U(JJ)J

    move-result-wide p1

    .line 540
    invoke-interface {p0, v0, v2, v2}, Lj$/time/chrono/l;->D(III)Lj$/time/chrono/b;
    ...
    invoke-interface {p0, v1}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-interface {p0, v3}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 547
    :try_start_0
    invoke-interface {p0, v0, v1, p1}, Lj$/time/chrono/l;->D(III)Lj$/time/chrono/b;
    ...
    .line 549
    :catch_0
    invoke-interface {p0, v0, v1, v2}, Lj$/time/chrono/l;->D(III)Lj$/time/chrono/b;
    ...
    .line 549
    invoke-interface {p1, p2}, Lj$/time/chrono/b;->i(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
.method public z(Ljava/util/Map;Lj$/time/format/E;)Lj$/time/chrono/b;
    .locals 7
    ...
    invoke-static {v4, v5}, Lj$/com/android/tools/r8/a;->M(J)I
    ...
    .line 508
    invoke-interface {p0, v2}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-interface {p0, p2}, Lj$/time/chrono/l;->O(I)Lj$/time/chrono/m;
    ...
    .line 513
    invoke-interface {p0, p2, v5}, Lj$/time/chrono/l;->x(II)Lj$/time/chrono/b;

    move-result-object p2

    .line 514
    invoke-interface {p2}, Lj$/time/chrono/b;->A()Lj$/time/chrono/m;
    ...
    invoke-static {p1, v2, v0, v1}, Lj$/time/chrono/a;->l(Ljava/util/Map;Lj$/time/temporal/a;J)V
    ...
    .line 520
    :cond_3
    invoke-interface {p0}, Lj$/time/chrono/l;->K()Ljava/util/List;
    ...
    .line 530
    invoke-interface {p0, p2}, Lj$/time/chrono/l;->H(Lj$/time/temporal/a;)Lj$/time/temporal/u;

...
.method public static synthetic j(Ljava/util/stream/LongStream;)Lj$/util/stream/l0;
    .locals 1
    ...
    iget-object p0, p0, Lj$/util/stream/k0;->a:Lj$/util/stream/l0;
...
# virtual methods
.method public final synthetic a()Lj$/util/stream/l0;
    .locals 2
    ...
    invoke-static {v0}, Lj$/util/stream/j0;->j(Ljava/util/stream/LongStream;)Lj$/util/stream/l0;
...
.method public final synthetic asDoubleStream()Lj$/util/stream/C;
    ...
    invoke-static {v0}, Lj$/util/stream/A;->j(Ljava/util/stream/DoubleStream;)Lj$/util/stream/C;
...
.method public final synthetic average()Lj$/util/OptionalDouble;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->D(Ljava/util/OptionalDouble;)Lj$/util/OptionalDouble;
...
.method public final synthetic b()Lj$/util/stream/l0;
    .locals 2
...
.method public final synthetic boxed()Lj$/util/stream/Stream;
    ...
    invoke-static {v0}, Lj$/util/stream/X2;->j(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic c()Lj$/util/stream/l0;
    .locals 2
...
.method public final synthetic d()Lj$/util/stream/l0;
    .locals 2
...
.method public final synthetic distinct()Lj$/util/stream/l0;
    .locals 1
...
.method public final e(Lj$/util/o;)Lj$/util/stream/l0;
    ...
    invoke-static {p1}, Lj$/util/stream/j0;->j(Ljava/util/stream/LongStream;)Lj$/util/stream/l0;
...
.method public final synthetic findAny()Lj$/util/OptionalLong;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->F(Ljava/util/OptionalLong;)Lj$/util/OptionalLong;
...
.method public final synthetic iterator()Lj$/util/K;
    ...
    invoke-direct {v1, v0}, Lj$/util/I;-><init>(Ljava/util/PrimitiveIterator$OfLong;)V
...
.method public final synthetic limit(J)Lj$/util/stream/l0;
    .locals 1
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Lj$/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/X2;->j(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic parallel()Lj$/util/stream/l0;
    .locals 1
...
.method public final synthetic peek(Ljava/util/function/LongConsumer;)Lj$/util/stream/l0;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/OptionalLong;
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->F(Ljava/util/OptionalLong;)Lj$/util/OptionalLong;
...
.method public final synthetic sequential()Lj$/util/stream/l0;
    .locals 1
...
.method public final synthetic skip(J)Lj$/util/stream/l0;
    .locals 1
...
.method public final synthetic sorted()Lj$/util/stream/l0;
    .locals 1
...
.method public final synthetic spliterator()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/Z;->a(Ljava/util/Spliterator;)Lj$/util/Spliterator;
...
.method public final synthetic spliterator()Lj$/util/V;
    .locals 1
    ...
    invoke-static {v0}, Lj$/util/T;->a(Ljava/util/Spliterator$OfLong;)Lj$/util/V;

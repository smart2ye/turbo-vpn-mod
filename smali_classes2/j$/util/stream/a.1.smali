...
.method public constructor <init>(Lj$/util/stream/a;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/a3;->l(II)I
...
# virtual methods
.method public final A(Lj$/util/Spliterator;Lj$/util/stream/l2;)Z
    .locals 3
    ...
    invoke-interface {p2, v1, v2}, Lj$/util/stream/l2;->l(J)V

    .line 502
    invoke-virtual {v0, p1, p2}, Lj$/util/stream/a;->G(Lj$/util/Spliterator;Lj$/util/stream/l2;)Z

    move-result p1

    .line 503
    invoke-interface {p2}, Lj$/util/stream/l2;->k()V

    return p1
.end method

.method public final B(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/F0;
    .locals 2
    ...
    .line 545
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/a;->E(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/F0;
    ...
    .line 548
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/a;->I(JLjava/util/function/IntFunction;)Lj$/util/stream/x0;

    move-result-object p2

    .line 550
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/a;->Q(Lj$/util/Spliterator;Lj$/util/stream/l2;)Lj$/util/stream/l2;

    invoke-interface {p2}, Lj$/util/stream/x0;->a()Lj$/util/stream/F0;
...
.method public final C(Lj$/util/stream/G3;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/G3;->c(Lj$/util/stream/a;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/G3;->b(Lj$/util/stream/a;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method public final D(Ljava/util/function/IntFunction;)Lj$/util/stream/F0;
    .locals 4
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/a;->J(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/F0;
    ...
    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/a;->B(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/F0;
...
.method public abstract E(Lj$/util/stream/a;Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/F0;
.end method
...
.method public abstract G(Lj$/util/Spliterator;Lj$/util/stream/l2;)Z
.end method

.method public abstract H()Lj$/util/stream/b3;
.end method

.method public abstract I(JLjava/util/function/IntFunction;)Lj$/util/stream/x0;
.end method

.method public J(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/F0;
    .locals 0
...
.method public K(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 710
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/a;->J(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/F0;
...
.method public abstract M(ILj$/util/stream/l2;)Lj$/util/stream/l2;
.end method
...
.method public final N(I)Lj$/util/Spliterator;
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/a3;->q(I)Z
    ...
    invoke-static {v4, v0}, Lj$/util/stream/a3;->l(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/a3;->l(II)I
...
.method public final Q(Lj$/util/Spliterator;Lj$/util/stream/l2;)Lj$/util/stream/l2;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lj$/util/stream/a;->R(Lj$/util/stream/l2;)Lj$/util/stream/l2;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lj$/util/stream/a;->z(Lj$/util/Spliterator;Lj$/util/stream/l2;)V

    return-object p2
.end method

.method public final R(Lj$/util/stream/l2;)Lj$/util/stream/l2;
    .locals 3
    ...
    invoke-virtual {v0, v2, p1}, Lj$/util/stream/a;->M(ILj$/util/stream/l2;)Lj$/util/stream/l2;
...
.method public final S(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-direct {v0, v1, p1}, Lj$/util/o;-><init>(ILjava/lang/Object;)V
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    invoke-direct {v1, v2, p0}, Lj$/util/o;-><init>(ILjava/lang/Object;)V
...
.method public final z(Lj$/util/Spliterator;Lj$/util/stream/l2;)V
    .locals 2
    ...
    invoke-interface {p2, v0, v1}, Lj$/util/stream/l2;->l(J)V
    ...
    .line 488
    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/a;->A(Lj$/util/Spliterator;Lj$/util/stream/l2;)Z

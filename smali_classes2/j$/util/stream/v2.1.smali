...
.method public final a()Ljava/lang/Object;
    ...
    .line 512
    iget v0, v0, Lj$/util/stream/a3;->e:I
    ...
    invoke-virtual {v1, v2, v0}, Lj$/util/stream/a;->Q(Lj$/util/Spliterator;Lj$/util/stream/l2;)Lj$/util/stream/l2;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-wide v7, v0, Lj$/util/stream/v2;->n:J

    add-long/2addr v5, v7

    iput-wide v5, p0, Lj$/util/stream/v2;->n:J
    ...
    .line 632
    :cond_1
    iget-wide v5, p0, Lj$/util/stream/v2;->n:J
    ...
    check-cast v5, Lj$/util/stream/F0;

    .line 637
    invoke-static {v0, v2, v5}, Lj$/util/stream/v1;->C(Lj$/util/stream/b3;Lj$/util/stream/F0;Lj$/util/stream/F0;)Lj$/util/stream/H0;
    ...
    .line 659
    iget-wide v6, p0, Lj$/util/stream/v2;->m:J

    cmp-long v0, v6, v3

    if-ltz v0, :cond_4

    invoke-interface {v5}, Lj$/util/stream/F0;->count()J
    ...
    :cond_4
    iget-wide v6, p0, Lj$/util/stream/v2;->n:J
    ...
    iget-object v10, p0, Lj$/util/stream/v2;->k:Ljava/util/function/IntFunction;

    invoke-interface/range {v5 .. v10}, Lj$/util/stream/F0;->h(JJLjava/util/function/IntFunction;)Lj$/util/stream/F0;
    ...
    .line 643
    :cond_6
    iget-wide v0, p0, Lj$/util/stream/v2;->m:J

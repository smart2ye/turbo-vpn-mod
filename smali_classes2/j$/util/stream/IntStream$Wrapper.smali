...
.method public final synthetic asLongStream()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asLongStream()Lj$/util/stream/l0;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-static {v0}, Lj$/com/android/tools/r8/a;->I(Lj$/util/OptionalInt;)Ljava/util/OptionalInt;
...
.method public final flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    .line 0
    invoke-interface {v0, v1}, Lj$/util/stream/IntStream;->x(Lj$/util/stream/K;)Lj$/util/stream/IntStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/G;
    ...
    iget-object v0, v0, Lj$/util/E;->a:Ljava/util/PrimitiveIterator$OfInt;
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->f()Lj$/util/stream/C;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->l()Lj$/util/stream/l0;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-static {p1}, Lj$/com/android/tools/r8/a;->I(Lj$/util/OptionalInt;)Ljava/util/OptionalInt;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfInt;
    ...
    invoke-static {v0}, Lj$/util/S;->a(Lj$/util/Spliterator$OfInt;)Ljava/util/Spliterator$OfInt;
...
.method public final summaryStatistics()Ljava/util/IntSummaryStatistics;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->summaryStatistics()Lj$/util/w;

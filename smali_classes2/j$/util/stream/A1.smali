...
# virtual methods
.method public final Q()Lj$/util/stream/Q1;
    .locals 4
    ...
    iget-object v1, p0, Lj$/util/stream/A1;->j:Ljava/lang/Object;

    check-cast v1, Lj$/util/stream/p;

    iget-object v2, p0, Lj$/util/stream/A1;->i:Ljava/lang/Object;

    check-cast v2, Ljava/util/function/Supplier;

    iget-object v3, p0, Lj$/util/stream/A1;->k:Ljava/lang/Object;

    check-cast v3, Ljava/util/function/ObjIntConsumer;

    invoke-direct {v0, v2, v3, v1}, Lj$/util/stream/N1;-><init>(Ljava/util/function/Supplier;Ljava/util/function/ObjIntConsumer;Lj$/util/stream/p;)V
    ...
    invoke-direct {v0, v1, v2, v3}, Lj$/util/stream/F1;-><init>(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)V
    ...
    invoke-direct {v0, v2, v3, v1}, Lj$/util/stream/D1;-><init>(Ljava/util/function/Supplier;Ljava/util/function/ObjDoubleConsumer;Lj$/util/stream/p;)V
    ...
    invoke-direct {v0, v2, v3, v1}, Lj$/util/stream/x1;-><init>(Ljava/util/function/Supplier;Ljava/util/function/ObjLongConsumer;Lj$/util/stream/p;)V

...
.method public static synthetic a(Lcom/google/common/util/concurrent/j;Lcom/google/common/util/concurrent/f;)V
    .locals 0
...
.method public static synthetic b(Lcom/google/common/util/concurrent/j;Ljava/lang/Runnable;Ljava/lang/Object;)V
    .locals 1
    ...
    .line 10
    .line 11
    invoke-virtual {p0, p2}, Lcom/google/common/util/concurrent/j;->A(Ljava/lang/Object;)Z
    :try_end_0
...
.method public static synthetic d(Lcom/google/common/util/concurrent/f;Lcom/google/common/util/concurrent/j;Lcom/google/common/util/concurrent/a;)V
    .locals 0

    .line 1
    :try_start_0
    invoke-static {p0}, Lcom/google/common/util/concurrent/c;->b(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    .line 5
    :try_start_1
    invoke-interface {p2, p0}, Lcom/google/common/util/concurrent/a;->apply(Ljava/lang/Object;)Lcom/google/common/util/concurrent/f;
    ...
    .line 9
    invoke-virtual {p1, p0}, Lcom/google/common/util/concurrent/j;->C(Lcom/google/common/util/concurrent/f;)Z
    :try_end_1
    ...
    .line 39
    invoke-virtual {p1, p0}, Lcom/google/common/util/concurrent/j;->cancel(Z)Z
...
.method public static getDefaultDisplayLocale()Ljava/util/Locale;
    ...
    .line 6
    .line 7
    invoke-static {}, Lcom/google/android/exoplayer2/util/j;->a()Ljava/util/Locale$Category;
    ...
    .line 11
    invoke-static {v0}, Lcom/google/android/exoplayer2/util/k;->a(Ljava/util/Locale$Category;)Ljava/util/Locale;
...
.method private static isTrafficRestricted(Landroid/net/Uri;)Z
    ...
    .line 26
    .line 27
    invoke-static {v0, p0}, Lcom/google/android/exoplayer2/util/l;->a(Landroid/security/NetworkSecurityPolicy;Ljava/lang/String;)Z
...
.method public static postOrRunWithCompletion(Landroid/os/Handler;Ljava/lang/Runnable;Ljava/lang/Object;)Lcom/google/common/util/concurrent/f;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 6
    .line 7
    invoke-direct {v1, v0, p1, p2}, Lcom/google/android/exoplayer2/util/p;-><init>(Lcom/google/common/util/concurrent/j;Ljava/lang/Runnable;Ljava/lang/Object;)V
...
.method public static registerReceiverNotExported(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    .line 13
    invoke-static {p0, p1, p2, v0}, Lo1/f;->a(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;
...
.method public static startForegroundService(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, LM/a;->a(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
...
.method public static transformFutureAsync(Lcom/google/common/util/concurrent/f;Lcom/google/common/util/concurrent/a;)Lcom/google/common/util/concurrent/f;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 6
    .line 7
    invoke-direct {v1, v0, p0}, Lcom/google/android/exoplayer2/util/m;-><init>(Lcom/google/common/util/concurrent/j;Lcom/google/common/util/concurrent/f;)V
    ...
    .line 14
    invoke-virtual {v0, v1, v2}, Lcom/google/common/util/concurrent/j;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    .line 18
    .line 19
    invoke-direct {v1, p0, v0, p1}, Lcom/google/android/exoplayer2/util/n;-><init>(Lcom/google/common/util/concurrent/f;Lcom/google/common/util/concurrent/j;Lcom/google/common/util/concurrent/a;)V

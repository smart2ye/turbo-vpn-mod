.class public final Lsg/bigo/ads/be/d;
.super Lsg/bigo/ads/be/a;


# direct methods
.method public constructor <init>(Lsg/bigo/ads/ai/e$c;Ljava/util/Map;Landroid/content/Context;Lsg/bigo/ads/be/a$a;)V
    .locals 0
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Lsg/bigo/ads/be/a;-><init>(Lsg/bigo/ads/ai/e$c;Ljava/util/Map;Landroid/content/Context;Lsg/bigo/ads/be/a$a;)V
...
.method public final a(I)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v0, v1, v3}, Lsg/bigo/ads/be/a;->a(IIZ)V
...
.method public final b()Landroid/view/View;
    ...
    iget-object v0, p0, Lsg/bigo/ads/be/a;->h:Landroid/content/Context;
    ...
    iput-object v0, p0, Lsg/bigo/ads/be/a;->i:Landroid/view/View;
    ...
    iget-object v1, p0, Lsg/bigo/ads/be/a;->d:Ljava/lang/String;

    invoke-static {v0, v1}, Lsg/bigo/ads/be/a;->a(Landroid/widget/TextView;Ljava/lang/String;)V

    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Lsg/bigo/ads/be/d;->a(I)V

    iget-object v1, p0, Lsg/bigo/ads/be/a;->i:Landroid/view/View;
    ...
    new-instance v4, Lsg/bigo/ads/be/d$1;

    invoke-direct {v4, p0, v1}, Lsg/bigo/ads/be/d$1;-><init>(Lsg/bigo/ads/be/d;Landroid/widget/RadioGroup;)V
    ...
    iget-object v4, p0, Lsg/bigo/ads/be/a;->g:[Ljava/lang/String;
    ...
    :cond_1
    iget-object v4, p0, Lsg/bigo/ads/be/a;->e:Ljava/lang/String;

    iget-object v5, p0, Lsg/bigo/ads/be/a;->b:Ljava/util/Map;
    ...
    :goto_0
    iget-object v7, p0, Lsg/bigo/ads/be/a;->g:[Ljava/lang/String;
    ...
    iget-object v10, p0, Lsg/bigo/ads/be/a;->h:Landroid/content/Context;
    ...
    iget-object v8, p0, Lsg/bigo/ads/be/a;->h:Landroid/content/Context;
    ...
    iget-object v11, p0, Lsg/bigo/ads/be/a;->h:Landroid/content/Context;
    ...
    iget-object v13, p0, Lsg/bigo/ads/be/a;->h:Landroid/content/Context;
    ...
    invoke-static {v9, v7}, Lsg/bigo/ads/be/a;->a(Landroid/widget/TextView;Ljava/lang/String;)V

    invoke-virtual {v9, v2}, Landroid/widget/CompoundButton;->setButtonDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v7, p0, Lsg/bigo/ads/be/a;->h:Landroid/content/Context;
    ...
    new-instance v7, Lsg/bigo/ads/be/d$2;

    invoke-direct {v7, p0}, Lsg/bigo/ads/be/d$2;-><init>(Lsg/bigo/ads/be/d;)V
    ...
    iget-object v6, p0, Lsg/bigo/ads/be/a;->j:Lsg/bigo/ads/be/a$a;

    if-eqz v6, :cond_5

    iget-object v7, p0, Lsg/bigo/ads/be/a;->a:Lsg/bigo/ads/ai/e$c;

    iget-object v7, v7, Lsg/bigo/ads/ai/e$c;->d:Ljava/lang/String;

    invoke-interface {v6, v7, v4}, Lsg/bigo/ads/be/a$a;->a(Ljava/lang/String;Ljava/lang/String;)V

    :cond_5
    iput-object v4, p0, Lsg/bigo/ads/be/a;->c:Ljava/lang/String;
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Lsg/bigo/ads/be/a;->i:Landroid/view/View;

...
.method public static a(Landroid/content/Context;J)Lsg/bigo/ads/an/a;
    ...
    new-instance v0, Lsg/bigo/ads/bf/c$a;

    invoke-direct {v0, p1, p2}, Lsg/bigo/ads/bf/c$a;-><init>(J)V
    ...
    :try_start_0
    new-instance p1, Lsg/bigo/ads/bf/c$b;

    iget-boolean v1, v0, Lsg/bigo/ads/bf/c$a;->b:Z

    if-nez v1, :cond_1

    iput-boolean p2, v0, Lsg/bigo/ads/bf/c$a;->b:Z

    iget-object p2, v0, Lsg/bigo/ads/bf/c$a;->c:Ljava/util/concurrent/LinkedBlockingQueue;

    iget-wide v1, v0, Lsg/bigo/ads/bf/c$a;->a:J
    ...
    invoke-direct {p1, p2}, Lsg/bigo/ads/bf/c$b;-><init>(Landroid/os/IBinder;)V

    invoke-virtual {p1}, Lsg/bigo/ads/bf/c$b;->a()Ljava/lang/String;

    move-result-object p2

    invoke-virtual {p1}, Lsg/bigo/ads/bf/c$b;->b()Ljava/lang/Boolean;

...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec$Companion;-><init>(Lkotlin/jvm/internal/i;)V
...
.method private final detachTimeout(Lokio/k;)V
    ...
    .line 5
    sget-object v1, Lokio/C;->NONE:Lokio/C;

    .line 6
    .line 7
    invoke-virtual {p1, v1}, Lokio/k;->c(Lokio/C;)Lokio/k;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v1, p1, v0}, Lkotlin/text/p;->C(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final newChunkedSink()Lokio/z;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)Lokio/B;
    .locals 2
...
.method private final newFixedLengthSource(J)Lokio/B;
    .locals 2
...
.method private final newKnownLengthSink()Lokio/z;
    .locals 2
...
.method private final newUnknownLengthSource()Lokio/B;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/z;
    .locals 2
...
.method public openResponseBodySource(Lokhttp3/Response;)Lokio/B;
    .locals 4
    ...
    .line 33
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)Lokio/B;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    .line 25
    .line 26
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(Lokio/B;ILjava/util/concurrent/TimeUnit;)Z
